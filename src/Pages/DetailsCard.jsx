    ...
    return (
      <div className="overflow-x-hidden">
                    ...
                    <h1 className={styles.prieces}>
                      {discount ? (
                        <span className="flex">
                          ...
                          <div className="w-14 h-7 rounded-md bg-red-600 mt-5">
        ...
        <div className="flex justify-center  relative w-full mt-10 ml-10 m-40 flex-col">
          <h1 className=" text-3xl m-10 ml-0 h-4/12">Recent reviews:</h1>
                            ...
                            f.id === e.userId && (
                              <div className="flex ml-80 p-2 ">
                                ...
                                <div className="flex flex-col">
                                  <div className="flex ">
                                    <p className="text-black ml-6 text-3xl">
                                      {f.firstname}
                                    </p>
                                    <p className="text-black ml-6 text-3xl">
                                      {f.lastname}
