...
function EachOne(props) {
    return (
        <div className="inline-block bg-gradient-to-r from-purple-500 to-white-500 text-black-700 w-72 min-h-[10rem] shadow-lg rounded-md overflow-hidden m-10 " >{/*el bg no cambia */}
